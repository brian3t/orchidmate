...
<div id="reviews">
	...
	<div class="product-rating">
		<div class="product-rating-summary">
			...
			<p><?php printf( __( '%d reviews', WC_Product_Reviews_Pro::TEXT_DOMAIN ), wc_product_reviews_pro_get_comments_number( $product->id, 'review' ) ); ?></p>
		</div>
	...
	<?php if ( ! is_user_logged_in() && get_option('comment_registration') ) : ?>
		<noscript>
			...
			<p class="must-log-in"><?php printf( __( 'You must be <a href="%s">logged in</a> to join the discussion.', WC_Product_Reviews_Pro::TEXT_DOMAIN ), esc_url( add_query_arg( 'redirect_to', urlencode( get_permalink( get_the_ID() ) ), get_permalink( wc_get_page_id( 'myaccount' ) ) . '#tab-reviews' ) ) ); ?></p>
		</noscript>
	<?php endif; ?>
