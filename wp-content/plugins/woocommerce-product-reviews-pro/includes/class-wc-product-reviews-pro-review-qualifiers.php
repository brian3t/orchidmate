...
class WC_Product_Reviews_Pro_Review_Qualifiers {
	...
	public function create_review_qualifier_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'Review Qualifiers', 'taxonomy general name', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'singular_name'              => _x( 'Review Qualifier', 'taxonomy singular name', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'search_items'               => __( 'Search Review Qualifiers', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'all_items'                  => __( 'All Review Qualifiers', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'edit_item'                  => __( 'Edit Review Qualifier', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'view_item'                  => __( 'View Review Qualifier', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'update_item'                => __( 'Update Review Qualifier', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'add_new_item'               => __( 'Add New Review Qualifier', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'new_item_name'              => __( 'New Review Qualifier Name', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'separate_items_with_commas' => __( 'Separate qualifiers with commas', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'add_or_remove_items'        => __( 'Add or remove review qualifiers', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'choose_from_most_used'      => __( 'Choose from the most used review qualifiers', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'not_found'                  => __( 'No review qualifiers found.', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'menu_name'                  => __( 'Review Qualifiers', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
			'popular_items'              => __( 'Most used Qualifiers', WC_Product_Reviews_Pro::TEXT_DOMAIN ),
		);
	...
	public function edit_qualifier_options_field( $term ) {
		...
		?>
		<tr class="form-field">
			<th scope="row"><label for="options"><?php _ex( 'Options', 'review qualifier options', WC_Product_Reviews_Pro::TEXT_DOMAIN ); ?></label></th>
			<td><textarea name="options" id="options" rows="5" cols="50" class="large-text"><?php echo esc_textarea( $options ); ?></textarea><br>
			<span class="description"><?php _e( 'List review qualifier options above (1 per line).' ); ?></span></td>
		</tr>
		<?php
	}
	...
	public function add_qualifier_options_field( $term ) {
		...
		<div class="form-field">
			<label for="tag-options"><?php _ex( 'Options', 'review qualifier options', WC_Product_Reviews_Pro::TEXT_DOMAIN ); ?></label>
			<textarea name="options" id="tag-options" rows="5" cols="40"><?php echo esc_textarea( $options ); ?></textarea>
			<p><?php _e( 'List review qualifier options above (1 per line).' ); ?></p>
		</div>
		<?php
	}
